    ...
    <main className="min-h-screen bg-[#fdfdf9] px-4 py-5 text-[#151515] md:px-7">
      ...
      <article className="mx-auto max-w-3xl text-[19px] leading-8 text-black/80">
        ...
        <p className="mt-8">
          ...
          small public instructions are usually designed to disappear into the background. This index is
        ...
        <p className="mt-6">
          ...
          occasionally beautiful. The index treats them as found objects rather than jokes: a loose survey
        ...
        <p className="mt-6">
          ...
          appear, so the index can grow without losing its point of view.
        </p>
